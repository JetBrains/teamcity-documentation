...
[//]: # (help-id: TeamCity 2022.10 Release Notes)
...
**[TW-76124](https://youtrack.jetbrains.com/issue/TW-76124/S3-migration-allow-skipping-subproject-if-it-has-different-artifact-storage)** — S3 migration: allow skipping subproject if it has different artifact storage
...
**[TW-74984](https://youtrack.jetbrains.com/issue/TW-74984/S3-artifacts-migration-utility-allow-specifying-multiple-artifact-storages)** — S3 artifacts migration utility: allow specifying multiple artifact storages
...
**[TW-77336](https://youtrack.jetbrains.com/issue/TW-77336/Add-stdErr-field-to-VcsException)** — Add stdErr field to VcsException

**[TW-59247](https://youtrack.jetbrains.com/issue/TW-59247/Add-absolute-values-to-the-perfmon-chart)** — Add absolute values to the perfmon chart
...
**[TW-74064](https://youtrack.jetbrains.com/issue/TW-74064/Agent-pool-agents-page-undo-remove-agent-or-cloud-image)** — Agent pool agents page: undo remove agent or cloud image
...
**[TW-77863](https://youtrack.jetbrains.com/issue/TW-77863/Swarm-review-statuses-may-be-sent-to-unrelated-reviews-with-All-attached-VCS-roots-setting)** — Swarm review statuses may be sent to unrelated reviews with "All attached VCS roots" setting
...
**[TW-75189](https://youtrack.jetbrains.com/issue/TW-75189/Pending-changes-arent-updated-correctly-on-the-build-configuration-page-if-there-is-a-just-triggered-builds)** — Pending changes aren't updated correctly on the build configuration page if there is a just triggered builds
...
**[TW-75286](https://youtrack.jetbrains.com/issue/TW-75286/Max-running-builds-limitation-for-a-composite-build-should-not-prevent-start-of-dependencies-if-they-are-reachable-from-other)** — Max running builds limitation for a composite build should not prevent start of dependencies if they are reachable from other composite builds without this limitation
...
**[TW-74696](https://youtrack.jetbrains.com/issue/TW-74696/Actions-dropdown-disappears-after-changing-builds-filter)** — Actions dropdown disappears after changing builds filter
...
**[TW-77223](https://youtrack.jetbrains.com/issue/TW-77223/Pending-changes-counter-and-list-is-not-updated)** — Pending changes counter and list is not updated
...
**[TW-76558](https://youtrack.jetbrains.com/issue/TW-76558/Regression-Reverse-dependency-setting-being-ignored)** — Regression. Reverse dependency setting being ignored
...
**[TW-56505](https://youtrack.jetbrains.com/issue/TW-56505/Illegal-mix-of-collations-during-clean-up-when-database-has-utf8mb4-collection-and-the-server-does-not)** — Illegal mix of collations during clean up when database has utf8mb4 collection and the server does not
...
**[TW-76625](https://youtrack.jetbrains.com/issue/TW-76625/New-UI-shows-no-changes-for-a-build-unless-page-is-refreshed-project-page)** — New UI shows 'no changes' for a build unless page is refreshed (project page)
...
**[TW-74531](https://youtrack.jetbrains.com/issue/TW-74531/There-should-be-a-way-to-hide-build-status-popup-forever)** — There should be a way to hide build status popup forever
...
**[TW-75902](https://youtrack.jetbrains.com/issue/TW-75902/Consider-adding-support-for-no-motion-queries)** — Consider adding support for no-motion queries
...
**[TW-75099](https://youtrack.jetbrains.com/issue/TW-75099/Allow-to-finish-detached-build-using-build-credentials-corresponding-to-another-build)** — Allow to finish detached build using build credentials corresponding to another build
...
**[TW-77518](https://youtrack.jetbrains.com/issue/TW-77518/Different-numbers-of-failed-tests-are-shown-on-build-page)** — Different numbers of failed tests are shown on build page
...
**[TW-77268](https://youtrack.jetbrains.com/issue/TW-77268/Exception-in-estimator-thread-on-a-secondary-node)** — Exception in estimator thread on a secondary node
...
**[TW-77263](https://youtrack.jetbrains.com/issue/TW-77263/TeamCity-fails-to-open-test-details-in-Chrome)** — TeamCity fails to open test details in Chrome

**[TW-77258](https://youtrack.jetbrains.com/issue/TW-77258/Runner-selection-grid-is-shown-on-edit-build-step-page)** — Runner selection grid is shown on edit build step page
...
**[TW-77030](https://youtrack.jetbrains.com/issue/TW-77030/Duplicated-statuses-can-be-sent-by-commit-status-publisher)** — Duplicated statuses can be sent by commit status publisher
...
**[TW-76938](https://youtrack.jetbrains.com/issue/TW-76938/Test-output-stdout-logs-warnings-not-shown-when-expanding-failed-test)** — Test output (stdout, logs, warnings) not shown when expanding failed test
...
**[TW-76936](https://youtrack.jetbrains.com/issue/TW-76936/Maintenance-mark-isnt-displayed-in-the-sidebar-for-disconnected-agents)** — Maintenance mark isn't displayed in the sidebar for disconnected agents
...
**[TW-76939](https://youtrack.jetbrains.com/issue/TW-76939/Cannot-get-info-about-a-build-via-REST-API-500-server-error)** — Cannot get info about a build via REST API - 500 server error
...
**[TW-76474](https://youtrack.jetbrains.com/issue/TW-76474/Perforce-Shelve-trigger-does-not-fire-on-first-shelved-changelist-in-a-new-stream)** — Perforce Shelve trigger does not fire on first shelved changelist in a new stream
...
**[TW-76716](https://youtrack.jetbrains.com/issue/TW-76716/Searching-appears-to-search-in-projects-user-doesnt-have-permissions-for-causing-an-error-message)** — Searching appears to search in projects user doesn't have permissions for, causing an error message.
...
**[TW-76700](https://youtrack.jetbrains.com/issue/TW-76700/Builds-list-freezes-in-loading-state)** — Builds list freezes in 'loading' state
...
**[TW-74735](https://youtrack.jetbrains.com/issue/TW-74735/Build-status-popup-about-queued-build-may-disappear-too-quickly)** — Build status popup about queued build may disappear too quickly
...
**[TW-77270](https://youtrack.jetbrains.com/issue/TW-77270/Slow-processing-of-large-changelists-by-Perforce-VCS-Roots-with-multiple-streams)** — Slow processing of large changelists by Perforce VCS Roots with multiple streams
...
**[TW-76392](https://youtrack.jetbrains.com/issue/TW-76392/Build-randomly-hangs-on-Mac-M1-box-agent)** — Build randomly hangs on Mac M1 box agent
