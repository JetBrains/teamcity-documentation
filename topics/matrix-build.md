...
* Currently, the matrix build feature does not provide a mechanism for excluding specific parameter combinations from the matrix of builds. Related YouTrack ticket: [TW-84312](https://youtrack.jetbrains.com/issue/TW-84312).
