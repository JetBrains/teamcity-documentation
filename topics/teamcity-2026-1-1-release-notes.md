...
* [**TW-99898**](https://youtrack.jetbrains.com/issue/TW-99898) — Pipeline steps description isn't aligned with steps if docker file is used in some of the steps
...
* [**TW-100985**](https://youtrack.jetbrains.com/issue/TW-100985) — Build-scoped tokens UX: add descriptions and docs link
...
* [**TW-100713**](https://youtrack.jetbrains.com/issue/TW-100713) —  Build cannot resolve dep. parameters, if it has optional artifact dependency on another skipped conditional dependency
...
* [**TW-97441**](https://youtrack.jetbrains.com/issue/TW-97441) — Pipelines: Agent Requirement: RAM Amount condition doesn't work 
