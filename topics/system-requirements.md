...
* 60 projects and 300 build configurations (with roughly a quarter of them being active and running regularly)
* more than 300 builds a day
* about 2 MB log per build
* 50 build agents
* 50 web users and 30 IDE users
* 100 VCS roots (mainly Perforce and Subversion using server checkout) with the average changes checking interval of 120 seconds
