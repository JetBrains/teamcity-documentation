...
Currently, Node.js steps can only be run inside a Docker container. Refer to [](container-wrapper.md) for general information about available Docker settings.
