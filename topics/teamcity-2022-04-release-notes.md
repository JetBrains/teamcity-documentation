...
[**TW-75198**](https://youtrack.jetbrains.com/issue/TW-75198/TeamCity-does-not-remove-cleaned-up-builds-from-the-build_projec) — TeamCity does not remove cleaned up builds from the build\_project table  
