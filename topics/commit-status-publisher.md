...
* In the GitLab [project visibility](https://docs.gitlab.com/ee/user/public_access.html#change-project-visibility) settings for the project, enable the *CI/CD* option (or the *Pipelines* option in older GitLab versions).
