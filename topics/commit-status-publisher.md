...
To protect a branch from unverified pull requests, you can create a [branch protection rule](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/defining-the-mergeability-of-pull-requests/managing-a-branch-protection-rule) in your GitHub repository settings and set a TeamCity build as a required status check. When you create a pull request, GitHub will notify you if a build on requested changes fails and the required check has not passed.
