...
<img src="csat-form.png" width="706" alt="TeamCity feedback form"/>

The feedback (along with essential contextual data such as email, system information, and usage statistics) is sent to JetBrains. This data is **never** shared with third parties and is used solely to better understand user needs and improve TeamCity.
