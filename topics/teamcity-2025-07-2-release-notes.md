...
* [**TW-94996**](https://youtrack.jetbrains.com/issue/TW-94996) — Scheduled triggers don't have accurate description
* [**TW-93403**](https://youtrack.jetbrains.com/issue/TW-93403) — VCS root usages report leads to Versioned settings of virtual project created for Pipelines
* [**TW-94636**](https://youtrack.jetbrains.com/issue/TW-94636) — YAML/Visual view is not preserved between pipelines
* [**TW-94382**](https://youtrack.jetbrains.com/issue/TW-94382) — Misaligned "Reorder" button in Edit project settings
* [**TW-94321**](https://youtrack.jetbrains.com/issue/TW-94321) — 'Job reused' label is not added to all the reused jobs in the pipeline
* [**TW-95298**](https://youtrack.jetbrains.com/issue/TW-95298) — Removing Schedule Trigger Time Zone Crashes the Page
* [**TW-94909**](https://youtrack.jetbrains.com/issue/TW-94909) — Irrelevant help link in Pipelines UI
* [**TW-95327**](https://youtrack.jetbrains.com/issue/TW-95327) — Infinite loader when the pipeline is in queue until a page refresh
* [**TW-94721**](https://youtrack.jetbrains.com/issue/TW-94721) — Secondary VCS root added from Any Git URL looks like added from connection until Save
* [**TW-94782**](https://youtrack.jetbrains.com/issue/TW-94782) — Typo "repositorieses" in repository list when creating Pipeline from connection
