...
TeamCity preserves backward compatibility, so if you started working with Kotlin DSL in TeamCity 2017.2, you can continue using classes from the `jetbrains.buildServer.configs.kotlin.v2017_2` package even in TeamCity 2021.2.
