...
Instead of upgrading manually, you can always regenerate all of your Kotlin DSL scripts for your projects, unless you did not change them in the VCS repository since versioned settings were enabled in your project.   
To do this, you can disable and enable versioned settings again, and select the "_Overwrite_" option in the confirmation dialog.   
