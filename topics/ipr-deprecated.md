...
In IDEA project, a user can mark a source code folder as either `_sources_` or `_test_` root. This drop\-down list allows you to specify directories to look for tests: 
