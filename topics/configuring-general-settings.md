...
The status can be retrieved via the HTML status widget described below, or via a single icon with the help of [REST API](https://www.jetbrains.com/help/teamcity/rest/get-build-status-icon.html).
