...
5. In the __Authentication__ tab, enable _Authorization Code Flow_ and enter your TeamCity server's URL as the redirect URI.  
   ...
   >There is a [known issue](https://youtrack.jetbrains.com/issue/TW-72441) regarding the URIs necessary for connection. If you fail to authenticate in Space, you will see extra URIs that have to be added in this field as well. This issue will be resolved in 2021.2 EAP2.
   > 
   {type="warning"}
