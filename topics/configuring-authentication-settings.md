...
4. In the __Authentication__ tab, enable _Authorization Code Flow_ and enter your TeamCity server's URL as the redirect URI.  
   ...
   > 
   {type="warning"}
5. Copy the app's autogenerated _Client ID_ and _Client secret_.
