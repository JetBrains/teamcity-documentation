...
[//]: # (auxiliary-id: What's New in TeamCity 2021.2; What's New in TeamCity)
...
[Read more about this syntax](predefined-build-parameters.md#Overriding+Dependencies+Properties).
...
Before upgrading, we highly recommend reading about [important changes in version 2021.2 compared to 2021.1.x](upgrade-notes.md).
