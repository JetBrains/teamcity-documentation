...
Refreshable tokens are now enabled by default for such VCS Roots. Such tokens are refreshed more frequently than passwords or access tokens, therefore providing a more secure connection.
