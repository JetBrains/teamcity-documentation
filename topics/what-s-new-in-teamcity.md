...
> Starting with the 2023.05.1 bugfix update, the **Acquire new** button is also available for VCS roots configured using an [Azure DevOps OAuth 2.0 connection](configuring-connections.md#Azure+DevOps).
