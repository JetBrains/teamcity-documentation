...
</td><td>3.x</td><td>Version 3.9.11 is downloaded and installed after TeamCity server first starts. Versions 3.0.5, 3.1.1, 3.2.5, 3.3.9, 3.5.4, 3.6.3, 3.8.6, 3.9.6 are additionally installed if required by build configurations.</td></tr>
