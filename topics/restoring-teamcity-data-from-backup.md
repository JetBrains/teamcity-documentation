...
1. Open the TeamCity URL (by default, [`http://localhost/`](http://localhost/) for `exe` installtions and [`http://localhost:8111/`](http://localhost:8111/) for `tar.gz`) in a browser.
