...
Choose a repository to create a project or build configuration from — and TeamCity will scan it and suggest the settings, as described [here](creating-and-editing-build-configurations.md#Use+a+Repository+URL).
...
[Read more about this syntax](use-parameters-in-build-chains.md#Override+Input+Parameters+of+Preceding+Configurations).
