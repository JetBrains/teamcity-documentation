...
* create a [project from a Git repository URL](creating-and-editing-build-configurations.md#Use+a+Repository+URL)
* create a [VCS root from URL](guess-settings-from-repository-url.md)
...
* create a [project from a Git Space URL](creating-and-editing-build-configurations.md#Use+a+Repository+URL)
* create a [VCS root from URL](guess-settings-from-repository-url.md)
