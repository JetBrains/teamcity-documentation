...
* The version of .NET SDK bundled with the TeamCity Agent Docker image has been updated from 5.0 to 7.0.
* .NET Core 3.1 is no longer bundled with the TeamCity Agent Docker image.
