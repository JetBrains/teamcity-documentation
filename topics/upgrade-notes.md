...
Download and install [the fixed version](https://teamcity.jetbrains.com/repository/download/TeamCityThirdPartyPlugins_TeamcityBuildScanPlugin_Build/3847037:id/teamcity-build-scan-plugin-0.22-prerelease.zip) of this plugin. 

The latest released versions of the following plugins are compatible with TeamCity 2022.04. Install them from the JetBrains Marketplace:
