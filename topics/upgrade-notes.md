...
The following popular external plugins are not compatible with TeamCity 2022.04 and have to be updated before the upgrade.
...
The [Gradle Build Scan](https://github.com/etiennestuder/gradle-build-scan-teamcity-plugin) plugin is also incomplatible with 2022.04 but it does not have an updated version on the Marketplace yet. You can download [the fixed version](https://teamcity.jetbrains.com/repository/download/TeamCityThirdPartyPlugins_TeamcityBuildScanPlugin_Build/3847037:id/teamcity-build-scan-plugin-0.22-prerelease.zip) of the plugin from [teamcity.jetbrains.com](https://teamcity.jetbrains.com/buildConfiguration/TeamCityThirdPartyPlugins_TeamcityBuildScanPlugin_Build?mode=builds).
