...
TeamCity will attempt to [autodetect build steps](configuring-build-steps.md#Add+Steps+via+TeamCity+UI) in your project. You can confirm or reject the proposed steps and explore the project settings further.
