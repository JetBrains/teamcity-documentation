[//]: # (title: TeamCity 2025.07.3 Release Notes)
[//]: # (help-id: TeamCity 2025.07.3 Release Notes)

**Build 197398, 9 October 2025**
...
* [**TW-95775**](https://youtrack.jetbrains.com/issue/TW-95775) — Delay in cloud instances relations initialization causes wrong agent types assignment to the newly registering agents
* [**TW-95731**](https://youtrack.jetbrains.com/issue/TW-95731) — Connected DAGs traversing can slow down VCS triggers processing


### Security

Seven security problems have been fixed.
To learn more about fixed vulnerabilities directly related to TeamCity, check out our [Security Bulletin](https://www.jetbrains.com/privacy-security/issues-fixed/?product=TeamCity&version=2025.07.3).
