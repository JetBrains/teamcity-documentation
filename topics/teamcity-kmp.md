# Configure TeamCity for continuous integration of a Kotlin Multiplatform application

This article how to configure [TeamCity](https://www.jetbrains.com/teamcity/?source=google&medium=cpc&campaign=EMEA_en_DE_TeamCity_Branded&term=jetbrains%20teamcity&content=771411250243&gad_source=1&gad_campaignid=12704027475&gbraid=0AAAAADloJzi5LQxd_2GSPDer8jKk00xHY&gclid=CjwKCAjwyMnNBhBNEiwA-Kcgu9u9Gprgz8eDZs4p-aG14ZSEn3A3JARU_VXxZaEFPMrxGydCbvNJdxoCmToQAvD_BwE) to build, test, and deploy your KMP applications. TeamCity supports all major VCS providers (GitHub, GitLab, Bitbucket, Azure DevOps, Perforce, and more), allows you to implement highly scalable hybrid workflows with both local and cloud agents, and is packed with powerful features like multi-node setup for high availability, advanced user administration, integrations with issue trackers, and AI assistant.

You can grab your free TeamCity trial [here](https://www.jetbrains.com/teamcity/download/): choose between a Cloud version and enjoy JetBrains-hosted agents equipped with all major build tools and SDKs, or opt for TeamCity On-Premises for maximum control and free lifetime Professional license.
...
3. After you click **Create**, TeamCity asks you to choose the type of an object that will perform actual building tasks: a build configuration or a pipeline.
   ...
   Supports the full range of TeamCity features, allows you to store configuration settings as Kotlin DSL code, and provides the unmatched level of customization. As a downside, may require more user experience and manual setup.
   ...
   Geared towards less experienced users and simpler workflows, pipelines boast more intuitive design with smart visual editor, editable YAML configuration, and easily accessible settings. These entities were introduced in version 2025.11 and are currently missing some of build configurations' functionality.
