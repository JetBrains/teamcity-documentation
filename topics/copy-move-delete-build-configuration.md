...
If you attempt to delete a build configuration which has [dependent build configurations](configuring-dependencies.md), TeamCity will warn you about it. If you proceed with deletion, the dependencies will no longer function.