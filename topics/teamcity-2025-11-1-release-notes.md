...
* [**TW-97124**](https://youtrack.jetbrains.com/issue/TW-97124) — Webhook + Pull Request: New Pull Request doesn't trigger the run for a last PR (builds and pipelines)
...
* [**TW-97757**](https://youtrack.jetbrains.com/issue/TW-97757) — DOC: Actualize supported IDE versions
...
* [**TW-96939**](https://youtrack.jetbrains.com/issue/TW-96939) — Pipeline parameters: Original imported transitive parameter is used in jobs for overriden parameters
...
* [**TW-97579**](https://youtrack.jetbrains.com/issue/TW-97579) — Pipelines: Latest Visual Studio build tools not available within new dotnet runners (VS2026)
...
* [**TW-97026**](https://youtrack.jetbrains.com/issue/TW-97026) — Pipelines: Imported Parameters: Suggestions in steps show all parameters from parent, not the imported ones
...
* [**TW-96109**](https://youtrack.jetbrains.com/issue/TW-96109) — Pipelines: Favorite Projects overview -> Trends view cannot be opened with error 404, if there are pipelines on the server
...
* [**TW-96659**](https://youtrack.jetbrains.com/issue/TW-96659) — Pipeline Parameters: Autocomplete pop-up is not scrollable with more than N elements
