...
* Some settings are unavailable to TeamCity Cloud administrators: for example, changing the location for [storing external artifacts](configuring-artifacts-storage.md#external-artifacts-storage).
